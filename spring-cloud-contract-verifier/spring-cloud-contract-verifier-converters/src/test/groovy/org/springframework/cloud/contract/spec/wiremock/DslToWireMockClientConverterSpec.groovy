			...
			file.write("""
				org.springframework.cloud.contract.spec.Contract.make {
					request {
						...
						url '/api/12'
						headers {
							header 'Content-Type': 'application/vnd.org.springframework.cloud.contract.spec.twitter-places-analyzer.v1+json'
		...
		JSONAssert.assertEquals('''
{
  "request" : {
	...
	"headers" : {
	  "Content-Type" : {
		"equalTo" : "application/vnd.org.springframework.cloud.contract.spec.twitter-places-analyzer.v1+json"
	  }
	}
  },
  "response" : {
